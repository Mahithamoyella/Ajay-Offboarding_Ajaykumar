...
// CORS Middleware
app.use(cors({
  origin: ['http://18.234.138.238:8077', 'http://18.234.138.238:8078'],
  ...
  .then(() => {
    ...
    initializeDatabase().then(() => {
      app.listen(port, () => {
        ...
        console.log(`📄 Offboarding Form: http://18.234.138.238:${port}/offboarding.html`);
        console.log(`📊 HR Offboarding Dashboard: http://18.234.138.238:${port}/hrOffboarding.html`);
      });
    });
  })
  .catch(err => {
